...
// Consulta para buscar itens da ordem de serviço com o ID da ordem específico
        ...
        <div class="row">
            <div class="col-md-6 mx-auto">
                <div class="box">
                    ...
                    <form action="itens_os.php?id=<?= $id_ordem ?>" method="POST">
                        <div class="form-group">
                            <label for="id_ordem">ID da Ordem:</label>
                            <input type="number" id="id_ordem" name="id_ordem" value="<?= htmlspecialchars($id_ordem) ?>" required class="form-control" readonly>
                        </div>
