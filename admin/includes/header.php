                ...
                <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                    ...
                    <div class="offcanvas-body" id="navbar">
                        <ul class="navbar-nav justify-content-evenly  flex-grow-1 pe-3" id="itens-navbar">
                            ...
                            <!-- links do nav -->
                            <li class="nav-item">
                                <a href="principal.php" id="nav" class="nav-link mx-lg-2"> <h1>Home</h1></a>
                            </li>
                            
                            <li class="nav-item">
                                <a href="usuarios.php" id="nav" class="nav-link mx-lg-2"> <h1>Usuarios</h1> </a>
                            </li>

                            <li class="nav-item">
                                <a href="clientes.php" id="nav" class="nav-link mx-lg-2"> <h1>Clientes</h1> </a>
                            </li>
